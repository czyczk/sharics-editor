...
@Component({
  ...
  templateUrl: './playback-control-bar-deprecated.component.html',
  styleUrls: ['./playback-control-bar-deprecated.component.scss']
})
export class PlaybackControlBarDeprecatedComponent implements OnInit, OnDestroy {
