...
@Component({
  selector: 'app-sidebar-settings-deprecated',
  templateUrl: './sidebar-settings-deprecated.component.html',
  styleUrls: ['./sidebar-settings-deprecated.component.scss']
})
export class SidebarSettingsDeprecatedComponent implements OnInit, OnDestroy {
