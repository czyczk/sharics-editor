...
@Component({
  selector: 'app-sidebar-normal-deprecated',
  templateUrl: './sidebar-normal-deprecated.component.html',
  styleUrls: ['./sidebar-normal-deprecated.component.scss']
})
export class SidebarNormalDeprecatedComponent implements OnInit, OnDestroy {
